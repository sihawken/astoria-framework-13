...
rpm-ostree override remove kernel kernel-core kernel-modules --install ${KERNEL_REPO}/kernel-${KERNEL_VERSION}.rpm --install ${KERNEL_REPO}/kernel-core-${KERNEL_VERSION}.rpm --install ${KERNEL_REPO}/kernel-modules-${KERNEL_VERSION}.rpm
