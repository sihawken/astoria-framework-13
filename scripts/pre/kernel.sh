...
rpm-ostree override remove kernel kernel-core kernel-modules kernel-modules-extra kernel-devel-matched
...
rpm-ostree install ${KERNEL_REPO}/kernel-devel-${KERNEL_VERSION}.rpm ${KERNEL_REPO}/kernel-devel-matched-${KERNEL_VERSION}.rpm ${KERNEL_REPO}/kernel-uki-virt-${KERNEL_VERSION}.rpm
